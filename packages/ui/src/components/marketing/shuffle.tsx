  ...
  useGSAP(
    () => {
      ...
      const build = () => {
        ...
        chars.forEach(ch => {
          const parent = ch.parentElement as HTMLElement;
          if (!parent) return;
      ...
      const play = () => {
        ...
        const tl = gsap.timeline({
          ...
          onRepeat: () => {
            ...
            if (isVertical) {
              gsap.set(strips, { y: i => parseFloat(strips[i].getAttribute('data-start-y') || '0') });
            } else {
              gsap.set(strips, { x: i => parseFloat(strips[i].getAttribute('data-start-x') || '0') });
            }
            onShuffleComplete?.();
          },
          onComplete: () => {
        ...
        const addTween = (targets: HTMLElement[], at: number) => {
          ...
          if (isVertical) vars.y = i => parseFloat(targets[i].getAttribute('data-final-y') || '0');
          else vars.x = i => parseFloat(targets[i].getAttribute('data-final-x') || '0');
